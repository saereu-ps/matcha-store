...
# AI-DLC Workflow Active — marketpro-grocery
...
- **Manifest**: `.aidlc/workflow/marketpro-grocery/aidlc-manifest.yaml`
- **Specs**: `.aidlc/specs/marketpro-grocery/`
- **Workflow**: `.aidlc/workflow/marketpro-grocery/`
...
1. Read `.aidlc/workflow/marketpro-grocery/aidlc-manifest.yaml` for current state
